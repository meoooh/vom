...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Question.category' to match new field type.
        db.rename_column(u'vom_question', 'category', 'category_id')
        # Changing field 'Question.category'
        db.alter_column(u'vom_question', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vom.CategoryOfQuestion']))
        # Adding index on 'Question', fields ['category']
        db.create_index(u'vom_question', ['category_id'])


    def backwards(self, orm):
        # Removing index on 'Question', fields ['category']
        db.delete_index(u'vom_question', ['category_id'])


        # Renaming column for 'Question.category' to match new field type.
        db.rename_column(u'vom_question', 'category_id', 'category')
        # Changing field 'Question.category'
        db.alter_column(u'vom_question', 'category', self.gf('django.db.models.fields.CharField')(max_length=254))
    ...
    models = {
        ...
        u'vom.question': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vom.CategoryOfQuestion']"}),
            'contents': ('django.db.models.fields.TextField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'writer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vom.VomUser']"})
