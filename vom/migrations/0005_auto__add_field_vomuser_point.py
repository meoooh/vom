...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VomUser.point'
        db.add_column(u'vom_vomuser', 'point',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VomUser.point'
        db.delete_column(u'vom_vomuser', 'point')
    ...
    models = {
        ...
        u'vom.vomuser': {
            ...
            'point': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
